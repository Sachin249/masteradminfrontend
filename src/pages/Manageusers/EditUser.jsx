...
const EditUser = (props) => {
 ...
 const {name,email,password,phone,role,address}=data
  ...
  const validate = yup.object({
    ...
    role: yup.string().required("Role Type required"),
  });
  const handleSubmit = async (e) => {
    ...
    await axios
      .post(`${REACT_APP_API_PORT}api/admin/employee/update/${id}`, formdata, {
        headers: {
                      ...
                      <div className="p-7">
                        ...
                        >
                          ...
                          <div className="flex flex-col items-center justify-center space-y-3">
                            ...
                            : values?.image[0]} alt='profile' className='rounded-full h-30 w-30 sm:h-44 sm:w-44' />
                            }
