...
// tab function
    ...
    const emailValidation = (e) => {
      ...
      if (!regex.test(e.target.value)) {
        setEmailErr({ mess: "This is not a valid email format!" });
      } else {
        setEmailErr({});
      }
    };
  const submitHandler=async(e)=>{
    ...
    setapiIsLoading(true)
     await axios.post(`${REACT_APP_API_PORT}api/adminauth/postlogin`,formdata,{
...
if(res?.data?.message === 'Login Successful')
{
  ...
  // console.log(res?.data?.message)
  // props.setAlertBox(true)
  // props.showAlert(res?.data?.message,"red")
...
setapiIsLoading(false)
  ...
  const userLogin=async(e)=>{
    ...
    formdata.append('password',password)
    setapiIsLoading(true)
     await axios.post(`${REACT_APP_API_PORT}api/userauth/login`,formdata,{
